...
class MWojcik_Getresponse_Model_Consts
{

    const X_APP_ID = '71609442-d357-47ea-8c7e-ebc36a6b1a66';
    const USER_AGENT = 'mw-magento 1.0.0';

    const ENV_SMB = 'smb';
    const ENV_MXPL = 'mxpl';
    const ENV_MXUS = 'mxus';

    const URL_SMB = 'https://api.getresponse.com/v3/';
